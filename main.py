...
import sys
writer = SummaryWriter("runs/lipreading")
...
def load_args(default_config=None):
    ...
    # -- directory
    parser.add_argument('--data-dir', default=r'./datasets/visual_data', help='Loaded data directory')
